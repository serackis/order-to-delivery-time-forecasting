...
'''
Code for executing regression pipeline
'''
...
from utils.prediction import xgb_predict_reg, rf_predict_reg, SV_predict_reg, ensemble_predict_reg
...
def main(FLAGS):
    ...
    from sklearn.ensemble import RandomForestRegressor  # pylint: disable=C0415
    from sklearn.ensemble import VotingRegressor  # pylint: disable=C0415
    from sklearn.svm import SVR  # pylint: disable=C0415
    ...
    logger.info("Average Streaming Inference Time for Voting Regressor model: %s", str(avg_stream_time))
